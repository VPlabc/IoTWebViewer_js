...
function socketIsDead(){
  ...
  $('#Connect_status').removeClass("text-mrdiy-light")
  $('#Connect_status').addClass("text-mrdiy-red")
...
function changePrinterStatus(new_status){
  ...
  switch(Sensor_status) {
    ...
    case "idle":
        ...
        $('#Sensor_status').addClass("text-mrdiy-green")
        break;

    case "active":
        $('#Sensor_status').html("Active")
        $('#Sensor_status').removeClass()
        $('#Sensor_status').addClass("text-mrdiy-red")
...
function printerIsPrinting(){
    ...
    $('#Sensor_status').removeClass()
    $('#Sensor_status').addClass("text-mrdiy-light text-capitalize")
    $('#progress-bar').removeClass()
		$('#progress-bar').addClass("progress-bar")
...
function printerIsDone(){
    ...
    $('#Sensor_status').html(Sensor_status)
    $('#Sensor_status').removeClass()
    $('#Sensor_status').addClass("text-mrdiy-green text-capitalize")
    $('#current_file_process').html("")
